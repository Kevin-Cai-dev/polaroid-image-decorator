...
INSTA_OPTIMISED = "insta_optimised"
...
INSTA_OPTIMISED_HELP = "resize image to optimise instagram uploads"
...
RATIO_5_4_HELP = "create an image with a 5:4 aspect ratio if possible, following original orientation"
RATIO_3_2_HELP = "create an image with a 3:2 aspect ratio if possible, following original orientation"
RATIO_16_9_HELP = "create an image with a 16:9 aspect ratio if possible, following original orientation"
